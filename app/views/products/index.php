                                    ...
                                    <div class="single-products-box">
                                        <div class="products-image">
                                            <a href="<?=base_url('product/'.$product['slug'])?>">
                                                <img src="<?=base_url('assets/img/products/img'.$product['id'].'.jpg')?>" class="main-image" alt="image">
                                                <img src="<?=base_url('assets/img/products/img-hover'.$product['id'].'.jpg')?>" class="hover-image" alt="image">
                                            </a>
                                        ...
                                        <div class="products-content">
                                            <h3><a href="<?=base_url('product/'.$product['slug'])?>"><?=$product['title']?></a></h3>
                                            <div class="price">
