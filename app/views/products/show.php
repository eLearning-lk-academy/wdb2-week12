                    ...
                    <div class="col-lg-5 col-md-12">
                        <div class="products-details-image">
                            <ul class="products-details-image-slides">
                                <li><img src="<?=base_url('assets/img/products/img3.jpg')?>" alt="image"></li>
                                <li><img src="<?=base_url('assets/img/products/img4.jpg')?>" alt="image"></li>
                                <li><img src="<?=base_url('assets/img/products/img-hover3.jpg')?>" alt="image"></li>
                                <li><img src="<?=base_url('assets/img/products/img-hover4.jpg')?>" alt="image"></li>
                                <li><img src="<?=base_url('assets/img/products/img7.jpg')?>" alt="image"></li>
                            </ul>
                    ...
                    <div class="products-slides owl-carousel owl-theme">
                        <div class="single-products-box">
                            <div class="products-image">
                                <a href="#">
                                    <img src="<?=base_url('assets/img/products/img1.jpg')?>" class="main-image" alt="image">
                                    <img src="<?=base_url('assets/img/products/img-hover1.jpg')?>" class="hover-image" alt="image">
                                </a>
                        ...
                        <div class="single-products-box">
                            <div class="products-image">
                                <a href="#">
                                    <img src="<?=base_url('assets/img/products/img2.jpg')?>" class="main-image" alt="image">
                                    <img src="<?=base_url('assets/img/products/img-hover2.jpg')?>" class="hover-image" alt="image">
                                </a>
                        ...
                        <div class="single-products-box">
                            <div class="products-image">
                                <a href="#">
                                    <img src="<?=base_url('assets/img/products/img3.jpg')?>" class="main-image" alt="image">
                                    <img src="<?=base_url('assets/img/products/img-hover3.jpg')?>" class="hover-image" alt="image">
                                </a>
                        ...
                        <div class="single-products-box">
                            <div class="products-image">
                                <a href="#">
                                    <img src="<?=base_url('assets/img/products/img4.jpg')?>" class="main-image" alt="image">
                                    <img src="<?=base_url('assets/img/products/img-hover4.jpg')?>" class="hover-image" alt="image">
                                </a>
                        ...
                        <div class="single-products-box">
                            <div class="products-image">
                                <a href="#">
                                    <img src="<?=base_url('assets/img/products/img5.jpg')?>" class="main-image" alt="image">
                                    <img src="<?=base_url('assets/img/products/img-hover5.jpg')?>" class="hover-image" alt="image">
                                </a>
                        ...
                        <div class="single-products-box">
                            <div class="products-image">
                                <a href="#">
                                    <img src="<?=base_url('assets/img/products/img6.jpg')?>" class="main-image" alt="image">
                                    <img src="<?=base_url('assets/img/products/img-hover6.jpg')?>" class="hover-image" alt="image">
                                </a>
